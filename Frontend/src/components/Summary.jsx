...
const SummaryPage = () => {
    ...
    const fetchVideoDetails = async () => {
      try {
        const response = await axios.get(
          `${config.NODE_BACKEND}/api/video/summary/${id}`,
          {
  ...
  if (!videoDetails) {
    return (
      <div className="min-w-full min-h-[20vh] flex items-center justify-center font-semibold text-2xl">
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-[80vh] shadow-md rounded-lg">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <h2 className="md:text-2xl text-xl font-semibold text-blue-600 mb-4">
          {videoDetails.title === "null" ? "No Title" : videoDetails.title}
        </h2>
